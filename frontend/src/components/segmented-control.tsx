  ...
  return (
    ...
    >
      {pill && (
        <span
          aria-hidden
          className="absolute top-1 bottom-1 rounded-md bg-background shadow-sm ring-1 ring-border/60 motion-safe:transition-[left,width] motion-safe:duration-300 motion-safe:ease-out"
